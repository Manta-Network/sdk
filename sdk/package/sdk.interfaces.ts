...
export interface IMantaSdk {
  ...
  toPrivateSign(asset_id: AssetId, amount: number, onlySign: boolean): Promise<void>;
  privateTransfer(asset_id: AssetId, amount: number, address: Address, onlySign: boolean): Promise<void>;
  toPublic(asset_id: AssetId, amount: number, onlySign: boolean): Promise<void>;
