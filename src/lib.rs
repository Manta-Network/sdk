...
/// Trusted Setup
///
/// Serialized Structured Reference Strings (SRSs) for trusted setups used in Zero-Knowledge Proof
/// Systems.
pub mod trusted_setup {
    /// Trusted Setup for the BLS12-381 Curve
    ///
    /// These parameters were generated by the Sapling MPC conducted by the ZCash Foundation. See
    /// <https://zfnd.org/conclusion-of-the-powers-of-tau-ceremony> for more information.
    pub mod bls12_381 {
        define_lfs!(
            PowersOfTauG1,
            "Powers of Tau over the G1 Curve up to 2^21 Elements",
            "/data/trusted-setup/bls12-381/powers-of-tau-g1"
        );
        define_lfs!(
            PowersOfTauG2,
            "Powers of Tau over the G2 Curve up to 2^21 Elements",
            "/data/trusted-setup/bls12-381/powers-of-tau-g2"
        );
    }
}
