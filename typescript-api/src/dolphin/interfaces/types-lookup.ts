...
declare module "@polkadot/types/lookup" {
  ...
  /**
   * @name CumulusPalletParachainSystemEvent (25)
   */
  ...
  /**
   * @name PalletDemocracyVoteThreshold (31)
   */
  ...
  /**
   * @name PalletDemocracyVoteAccountVote (34)
   */
  ...
  /**
   * @name MantaCollatorSelectionEvent (41)
   */
  export interface MantaCollatorSelectionEvent extends Enum {
    ...
    readonly isNewEvictionBaseline: boolean;
    readonly asNewEvictionBaseline: u8;
    readonly isNewEvictionTolerance: boolean;
    readonly asNewEvictionTolerance: u8;
    readonly type:
      | "NewInvulnerables"
  ...
  /**
   * @name FrameSupportScheduleLookupError (48)
   */
  ...
  /**
   * @name XcmV1MultilocationJunctions (56)
   */
  ...
  /**
   * @name XcmV0JunctionNetworkId (59)
   */
  ...
  /**
   * @name XcmV1MultiassetAssetId (71)
   */
  ...
  /**
   * @name XcmV1MultiassetFungibility (72)
   */
  ...
  /**
   * @name XcmV1MultiassetAssetInstance (73)
   */
  ...
  /**
   * @name XcmV1MultiassetMultiAssetFilter (81)
   */
  ...
  /**
   * @name XcmV1MultiassetWildMultiAsset (82)
   */
  ...
  /**
   * @name XcmV1MultiassetWildFungibility (83)
   */
  ...
  /**
   * @name XcmVersionedMultiAssets (86)
   */
  ...
  /**
   * @name XcmVersionedMultiLocation (91)
   */
  ...
  /**
   * @name CumulusPalletDmpQueueEvent (93)
   */
  ...
  /**
   * @name OrmlXtokensModuleEvent (94)
   */
  export interface OrmlXtokensModuleEvent extends Enum {
    readonly isTransferred: boolean;
    readonly asTransferred: {
      readonly sender: AccountId32;
      readonly currencyId: DolphinRuntimeCurrencyId;
      readonly amount: u128;
      readonly dest: XcmV1MultiLocation;
    } & Struct;
    ...
    readonly asTransferredMultiCurrencies: {
      readonly sender: AccountId32;
      readonly currencies: Vec<ITuple<[DolphinRuntimeCurrencyId, u128]>>;
      readonly dest: XcmV1MultiLocation;
    } & Struct;
  ...
  /**
   * @name DolphinRuntimeCurrencyId (95)
   */
  export interface DolphinRuntimeCurrencyId extends Enum {
    readonly isMantaCurrency: boolean;
    readonly asMantaCurrency: u32;
    readonly type: "MantaCurrency";
  }
  ...
  /**
   * @name PalletAssetManagerEvent (104)
   */
  export interface PalletAssetManagerEvent extends Enum {
    readonly isAssetRegistered: boolean;
    readonly asAssetRegistered: {
      readonly assetId: u32;
      readonly assetAddress: MantaPrimitivesAssetsAssetLocation;
      readonly metadata: MantaPrimitivesAssetsAssetRegistrarMetadata;
    } & Struct;
    readonly isAssetLocationUpdated: boolean;
    readonly asAssetLocationUpdated: {
      readonly assetId: u32;
      readonly location: MantaPrimitivesAssetsAssetLocation;
    } & Struct;
  ...
  /**
   * @name MantaPrimitivesAssetsAssetLocation (105)
   */
  export interface MantaPrimitivesAssetsAssetLocation
    extends XcmVersionedMultiLocation {}

  /**
   * @name MantaPrimitivesAssetsAssetRegistrarMetadata (106)
   */
  export interface MantaPrimitivesAssetsAssetRegistrarMetadata extends Struct {
    readonly name: Bytes;
    readonly symbol: Bytes;
    readonly decimals: u8;
  ...
  /**
   * @name PalletMantaPayEvent (109)
   */
  export interface PalletMantaPayEvent extends Enum {
    readonly isToPrivate: boolean;
    readonly asToPrivate: {
      readonly asset: PalletMantaPayAsset;
      readonly source: AccountId32;
    } & Struct;
    readonly isPrivateTransfer: boolean;
    readonly asPrivateTransfer: {
      readonly origin: AccountId32;
    } & Struct;
    readonly isToPublic: boolean;
    readonly asToPublic: {
      readonly asset: PalletMantaPayAsset;
      readonly sink: AccountId32;
    } & Struct;
    readonly type: "ToPrivate" | "PrivateTransfer" | "ToPublic";
  }

  /**
   * @name PalletMantaPayAsset (110)
   */
  export interface PalletMantaPayAsset extends Struct {
    readonly id: u32;
    readonly value: u128;
  }
  ...
  /**
   * @name FrameSupportWeightsPerDispatchClassWeightsPerClass (122)
   */
  ...
  /**
   * @name FrameSupportWeightsPerDispatchClassU32 (126)
   */
  ...
  /**
   * @name FrameSupportWeightsRuntimeDbWeight (127)
   */
  ...
  /**
   * @name PolkadotPrimitivesV1PersistedValidationData (134)
   */
  ...
  /**
   * @name PolkadotPrimitivesV1UpgradeRestriction (137)
   */
  ...
  /**
   * @name PolkadotPrimitivesV1AbridgedHrmpChannel (141)
   */
  ...
  /**
   * @name PolkadotPrimitivesV1AbridgedHostConfiguration (142)
   */
  export interface PolkadotPrimitivesV1AbridgedHostConfiguration
    extends Struct {
  ...
  /**
   * @name PolkadotCorePrimitivesInboundDownwardMessage (153)
   */
  ...
  /**
   * @name PolkadotCorePrimitivesInboundHrmpMessage (156)
   */
  ...
  /**
   * @name CumulusPalletParachainSystemError (159)
   */
  ...
  /**
   * @name PalletDemocracyPreimageStatus (182)
   */
  ...
  /**
   * @name PalletDemocracyReferendumInfo (184)
   */
  ...
  /**
   * @name PalletDemocracyReferendumStatus (185)
   */
  ...
  /**
   * @name PalletDemocracyVoteVoting (187)
   */
  ...
  /**
   * @name PalletDemocracyDelegations (190)
   */
  ...
  /**
   * @name PalletDemocracyVotePriorLock (191)
   */
  export interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /**
   * @name PalletDemocracyConviction (192)
   */
  ...
  /**
   * @name PalletDemocracyReleases (195)
   */
  ...
  /**
   * @name MantaCollatorSelectionCall (208)
   */
  export interface MantaCollatorSelectionCall extends Enum {
    ...
    readonly isSetEvictionBaseline: boolean;
    readonly asSetEvictionBaseline: {
      readonly percentile: u8;
    } & Struct;
    readonly isSetEvictionTolerance: boolean;
    readonly asSetEvictionTolerance: {
  ...
  export interface PalletSessionCall extends Enum {
    ...
    readonly asSetKeys: {
      readonly keys_: DolphinRuntimeOpaqueSessionKeys;
  ...
  /**
   * @name DolphinRuntimeOpaqueSessionKeys (210)
   */
  export interface DolphinRuntimeOpaqueSessionKeys extends Struct {
  ...
  /**
   * @name FrameSupportScheduleMaybeHashed (217)
   */
  ...
  /**
   * @name CumulusPalletDmpQueueCall (244)
   */
  ...
  /**
   * @name OrmlXtokensModuleCall (245)
   */
  ...
  /**
   * @name XcmVersionedMultiAsset (246)
   */
  ...
  export interface PalletUtilityCall extends Enum {
    ...
    readonly asDispatchAs: {
      readonly asOrigin: DolphinRuntimeOriginCaller;
      readonly call: Call;
    } & Struct;
  ...
  /**
   * @name DolphinRuntimeOriginCaller (249)
   */
  export interface DolphinRuntimeOriginCaller extends Enum {
  ...
  /**
   * @name PalletCollectiveRawOrigin (251)
   */
  ...
  /**
   * @name PalletAssetManagerCall (260)
   */
  export interface PalletAssetManagerCall extends Enum {
    ...
    readonly isSetUnitsPerSecond: boolean;
    readonly asSetUnitsPerSecond: {
      readonly assetId: Compact<u32>;
  ...
  /**
   * @name PalletMantaPayCall (261)
   */
  export interface PalletMantaPayCall extends Enum {
    readonly isToPrivate: boolean;
    readonly asToPrivate: {
      readonly post: PalletMantaPayTransferPost;
    } & Struct;
    readonly isPrivateTransfer: boolean;
    readonly asPrivateTransfer: {
      readonly post: PalletMantaPayTransferPost;
  ...
  /**
   * @name PalletMantaPayTransferPost (262)
   */
  export interface PalletMantaPayTransferPost extends Struct {
    readonly assetId: Option<u32>;
    readonly sources: Vec<u128>;
    readonly senderPosts: Vec<PalletMantaPaySenderPost>;
    readonly receiverPosts: Vec<PalletMantaPayReceiverPost>;
    readonly sinks: Vec<u128>;
    readonly validityProof: Bytes;
  }

  /**
   * @name PalletMantaPaySenderPost (265)
   */
  export interface PalletMantaPaySenderPost extends Struct {
    readonly utxoAccumulatorOutput: Bytes;
    readonly voidNumber: Bytes;
  }

  /**
   * @name PalletMantaPayReceiverPost (267)
   */
  export interface PalletMantaPayReceiverPost extends Struct {
    readonly utxo: Bytes;
    readonly note: PalletMantaPayEncryptedNote;
  }

  /**
   * @name PalletMantaPayEncryptedNote (268)
   */
  export interface PalletMantaPayEncryptedNote extends Struct {
    readonly ciphertext: U8aFixed;
  ...
  /**
   * @name PalletMembershipError (272)
   */
  ...
  /**
   * @name PalletAuthorshipUncleEntryItem (276)
   */
  ...
  /**
   * @name MantaCollatorSelectionCandidateInfo (279)
   */
  export interface MantaCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }

  /**
   * @name MantaCollatorSelectionError (281)
   */
  export interface MantaCollatorSelectionError extends Enum {
    ...
    readonly isNotAllowRemoveInvulnerable: boolean;
    readonly type:
      | "TooManyCandidates"
      | "Unknown"
      | "Permission"
  ...
  /**
   * @name PalletTreasuryProposal (291)
   */
  ...
  /**
   * @name PalletPreimageRequestStatus (297)
   */
  ...
  /**
   * @name PalletSchedulerScheduledV3 (304)
   */
  export interface PalletSchedulerScheduledV3 extends Struct {
    ...
    readonly call: FrameSupportScheduleMaybeHashed;
    readonly maybePeriodic: Option<ITuple<[u32, u32]>>;
    readonly origin: DolphinRuntimeOriginCaller;
  }
  ...
  /**
   * @name CumulusPalletXcmpQueueInboundChannelDetails (307)
   */
  ...
  /**
   * @name CumulusPalletXcmpQueueInboundState (308)
   */
  ...
  /**
   * @name PolkadotParachainPrimitivesXcmpMessageFormat (311)
   */
  ...
  /**
   * @name CumulusPalletXcmpQueueOutboundChannelDetails (314)
   */
  ...
  /**
   * @name CumulusPalletXcmpQueueOutboundState (315)
   */
  ...
  /**
   * @name CumulusPalletXcmpQueueQueueConfigData (317)
   */
  ...
  /**
   * @name CumulusPalletXcmpQueueError (319)
   */
  ...
  /**
   * @name PalletXcmVersionMigrationStage (329)
   */
  ...
  /**
   * @name CumulusPalletXcmError (331)
   */
  export type CumulusPalletXcmError = Null;

  /**
   * @name CumulusPalletDmpQueueConfigData (332)
   */
  ...
  /**
   * @name CumulusPalletDmpQueuePageIndexData (333)
   */
  ...
  /**
   * @name CumulusPalletDmpQueueError (336)
   */
  ...
  /**
   * @name OrmlXtokensModuleError (337)
   */
  ...
  /**
   * @name PalletAssetsAssetDetails (344)
   */
  ...
  /**
   * @name PalletAssetsAssetAccount (346)
   */
  ...
  /**
   * @name PalletAssetsExistenceReason (347)
   */
  ...
  /**
   * @name PalletAssetsAssetMetadata (350)
   */
  ...
  /**
   * @name PalletAssetManagerError (353)
   */
  export interface PalletAssetManagerError extends Enum {
    ...
    readonly isUpdateNonExistAsset: boolean;
  ...
  /**
   * @name PalletMantaPayUtxoMerkleTreePath (356)
   */
  export interface PalletMantaPayUtxoMerkleTreePath extends Struct {
    readonly leafDigest: Option<Bytes>;
    readonly currentPath: PalletMantaPayCurrentPath;
  }

  /**
   * @name PalletMantaPayCurrentPath (358)
   */
  export interface PalletMantaPayCurrentPath extends Struct {
    readonly siblingDigest: Bytes;
    readonly leafIndex: u32;
    readonly innerPath: Vec<Bytes>;
  }

  /**
   * @name PalletMantaPayError (360)
   */
  export interface PalletMantaPayError extends Enum {
    readonly isUninitializedSupply: boolean;
    readonly isZeroTransfer: boolean;
    readonly isBalanceLow: boolean;
    readonly isInvalidShape: boolean;
    readonly isAssetSpent: boolean;
    readonly isInvalidUtxoAccumulatorOutput: boolean;
    readonly isAssetRegistered: boolean;
    readonly isDuplicateSpend: boolean;
    readonly isDuplicateRegister: boolean;
    readonly isInvalidProof: boolean;
    readonly isLedgerUpdateError: boolean;
    readonly isInvalidSourceAccount: boolean;
    readonly isInvalidSinkAccount: boolean;
    readonly type:
      | "UninitializedSupply"
      | "ZeroTransfer"
      | "BalanceLow"
  ...
  /**
   * @name DolphinRuntimeRuntime (377)
   */
  export type DolphinRuntimeRuntime = Null;
} // declare module
